...
Hand-written source for `skill/testing.md`. Same marker format as `pitfalls.src.md`: `<!-- lede -->`,
...
`verify.md` is the checklist these findings are the footnotes to.
...
<!-- item: axe ignores a dangling `aria-controls` on a collapsed control -->
