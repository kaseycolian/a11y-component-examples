...
| Tier | Read | Size | For |
| --- | --- | --- | --- |
| 1 | `skill/index.md` | 3.3 KB | The roster. Find your component, then stop. |
| 1 | `skill/index.json` | 19.7 KB | Every field, for filtering by tag or SC. |
| 2 | `skill/components/<slug>.md` | ≤ 1.8 KB | The contract: roles, attributes, keys, states, what goes wrong, the JS API. |
| 3 | `skill/library/components/<slug>/component.{html,css,js}` | varies | The code. Copy from here. |
| 4 | `skill/library/components/<slug>/{docs.md,meta.json}` | varies | Why it is built that way. Read when the code surprises you. |
| 4 | `skill/{pitfalls,conventions,verify,testing}.md` | ≤ 15.4 KB | The traps that cost a real failure, and what a copied component assumes about your page. |
