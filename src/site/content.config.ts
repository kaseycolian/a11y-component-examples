 ...
 * `skill/library/components/<slug>/docs.md`, right next to the code it explains,
 * so the two are edited together and cannot drift.
 *
 * The `base` points outside srcDir on purpose -- skill/library/ is deliberately
