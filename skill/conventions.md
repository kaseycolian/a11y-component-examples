...
# What a copied component assumes
...
**Every color is a three-level fallback chain**
...
**An accent used as *text* is mixed toward the text color**
...
**Every duration is gated, never hardcoded**
...
**Every component ends with a `@media (forced-colors: active)` block**
...
**Every factory is idempotent and returns `destroy()`**
...
**Nothing is shared between components, deliberately**
...
**The `ac-` prefix is a collision guard**
...
**Pointer targets clear 24×24, and 44 is the intent**
...
**A landmark's name has to be unique on the page it lands in**
...
**Anything with an `id` needs `scroll-margin-top`**
...
## What is not part of a component
